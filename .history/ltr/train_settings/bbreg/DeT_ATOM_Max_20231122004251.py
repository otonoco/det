...
def run(settings):
    ...
    dataset_train = sampler.ATOMSampler([depthtrack_train], [1],
                                samples_per_epoch=2*settings.batch_size, max_gap=50, processing=data_processing_train)
    ...
    dataset_val = sampler.ATOMSampler([depthtrack_val], [1], samples_per_epoch=2*settings.batch_size, max_gap=50,
