...
from ltr.dataset import Lasot, Got10k, TrackingNet, MSCOCOSeq, MSCOCOSeq_depth, DepthTrack
...
def run(settings):
    ...
    dataset_train = sampler.DiMPSampler([coco_train, depthtrack_train], [1, 1],
    ...
    dataset_val = sampler.DiMPSampler([depthtrack_val], [1], samples_per_epoch=settings.val_samples_per_epoch,
